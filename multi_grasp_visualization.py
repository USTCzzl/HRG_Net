...
def parse_args():
    ...
    # Network
    parser.add_argument('--network', type=str,default="/home/zzl/Desktop/weight hrnet/c_rgb_epoch_30_iou_0.9850", help='Path to saved network to evaluate')

    # Dataset & Data & Training
    parser.add_argument('--dataset', type=str, default="depth",help='Dataset Name ("cornell" or "jaquard")')
    parser.add_argument('--dataset-path', type=str,default="/home/zzl/Desktop/multiobject/rgbd" ,help='Path to dataset')
